/*
  This file is based on @types/gl-matrix.
...
/// <reference path="../node_modules/typed-tuple-type/lib/index.d.ts" />

declare module 'gl-matrix' {
  // Global Utilities
  export const glMatrix: glMatrix;
  ...
  // vec2
  export interface vec2 extends Float32Tuple<2> {}
  export const vec2: {
    /**
     ...
     * @returns out
     */
    cross(out: vec3, a: vec2 | number[], b: vec2 | number[]): vec3;
     ...
     */
    angle(a: vec2 | number[], b: vec2 | number[]): number;
  ...
  // vec3
  export interface vec3 extends Float32Tuple<3> {}
  export const vec3: {
    /**
     ...
     * @returns {vec3} out
     */
    hermite(out: vec3, a: vec3 | number[], b: vec3 | number[], c: vec3 | number[], d: vec3 | number[], t: number): vec3;
     ...
     * @returns {vec3} out
     */
    bezier(out: vec3, a: vec3 | number[], b: vec3 | number[], c: vec3 | number[], d: vec3 | number[], t: number): vec3;
    ...
    forEach(
      ...
      offset: number,
      count: number,
      fn: (a: vec3 | number[], b: vec3 | number[]) => void,
    ): Float32Array;
  ...
  // vec4
  export interface vec4 extends Float32Tuple<4> {}
  export const vec4: {
    /**
    ...
    forEach(
      ...
      offset: number,
      count: number,
      fn: (a: vec4 | number[], b: vec4 | number[]) => void,
    ): Float32Array;
  ...
  // mat2
  export interface mat2 extends Float32Tuple<4> {}
  export const mat2: {
    /**
  ...
  // mat2d
  export interface mat2d extends Float32Tuple<6> {}
  export const mat2d: {
    /**
  ...
  // mat3
  export interface mat3 extends Float32Tuple<9> {}
  export const mat3: {
    /**
     ...
     * @returns out
     */
    translate(out: mat3, a: mat3, v: vec2 | number[]): mat3;
  ...
  // mat4
  export interface mat4 extends Float32Tuple<16> {}
  export const mat4: {
    /**
     ...
     * @returns out
     */
    lookAt(out: mat4, eye: vec3 | number[], center: vec3 | number[], up: vec3 | number[]): mat4;
     ...
     * @returns out
     */
    targetTo(out: mat4, eye: vec3 | number[], target: vec3 | number[], up: vec3 | number[]): mat4;
  ...
  // quat
  export interface quat extends Float32Tuple<4> {}
  export const quat: {
    /**
     ...
     * @returns {quat} out
     */
    setAxes(out: quat, view: vec3 | number[], right: vec3 | number[], up: vec3 | number[]): quat;
